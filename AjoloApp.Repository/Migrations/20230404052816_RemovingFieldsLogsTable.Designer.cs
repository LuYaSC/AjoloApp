...
namespace AjoloApp.Repository.Migrations
{
    ...
    [Migration("20230404052816_RemovingFieldsLogsTable")]
    partial class RemovingFieldsLogsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AjoloApp.Repository.AjoloAppRepository.Entities.ManageLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ManageLogs");
                });

            modelBuilder.Entity("AjoloApp.Repository.AjoloAppRepository.Entities.MaritalStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AjoloApp.Repository.AjoloAppRepository.Entities.Payment", b =>
                {
                    ...
                    b.Property<int>("EnrolledChildrenId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AjoloApp.Repository.AjoloAppRepository.Entities.Parent", b =>
                {
                    ...
                    b.HasOne("AjoloApp.Repository.AjoloAppRepository.Entities.MaritalStatus", "MaritalStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("AjoloApp.Repository.AjoloAppRepository.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("AjoloApp.Repository.AjoloAppRepository.Entities.EnrolledChildren", "EnrolledChildren")
                        .WithMany()
                        .HasForeignKey("EnrolledChildrenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
