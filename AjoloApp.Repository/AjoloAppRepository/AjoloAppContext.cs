...
namespace AjoloApp.Repository.AjoloAppRepository
{
    public class AjoloAppContext : IdentityDbContext<User, Role, int, IdentityUserClaim<int>, UserRole, IdentityUserLogin<int>, IdentityRoleClaim<int>, IdentityUserToken<int>>
    {
        public AjoloAppContext(DbContextOptions<AjoloAppContext> options) : base(options)
        {
        }
