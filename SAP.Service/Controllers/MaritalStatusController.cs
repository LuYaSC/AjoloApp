...
namespace SAP.Service.Controllers
{
    ...
    public class MaritalStatusController : ControllerBase
    {
        ...
        public MaritalStatusController(ITypeBusinessService<MaritalStatus> service)
        {
        ...
        [HttpGet]
        public Result<ReportResult> GenerateReport() => service.GeneratePdf("TIPOS DE ESTADO CIVIL REGISTRADOS");
    }
}
