...
namespace SAP.Service.Controllers
{
    ...
    public class PaymentOperationController : BaseController
    {
        ...
        public PaymentOperationController(IHttpContextAccessor httpContextAccessor, IConfiguration configuration,
                    ITypeBusinessService<PaymentOperation> service) : base(httpContextAccessor, configuration)
        {
        ...
        {
            var result = service.GeneratePdf("Lista de Tipos de Operacion de Pagos Registrados");
            SaveRequest();
            return result;
        }
    }
