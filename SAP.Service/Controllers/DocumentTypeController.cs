...
namespace SAP.Service.Controllers
{
    ...
    public class DocumentTypeController : ControllerBase
    {
        ...
        public DocumentTypeController(ITypeBusinessService<DocumentType> service)
        {
        ...
        [HttpGet]
        public Result<ReportResult> GenerateReport() => service.GeneratePdf("LISTA DE DOCUMENTOS REGISTRADOS");
    }
}
