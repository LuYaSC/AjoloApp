...
namespace SAP.Service.Controllers
{
    ...
    {
        ITypeBusinessService<City> service;

        public CityController(IHttpContextAccessor httpContextAccessor, IConfiguration configuration,
                    ITypeBusinessService<City> service) : base(httpContextAccessor, configuration)
        {
        ...
        {
            var result = service.GeneratePdf("Lista de Ciudades Registradas");
            SaveRequest();
            return result;
        }
    }
