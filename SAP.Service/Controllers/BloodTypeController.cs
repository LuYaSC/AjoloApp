...
namespace SAP.Service.Controllers
{
    ...
    public class BloodTypeController : ControllerBase
    {
        ...
        public BloodTypeController(ITypeBusinessService<BloodType> service)
        {
        ...
        [HttpGet]
        public Result<ReportResult> GenerateReport() => service.GeneratePdf("LISTA DE TIPOS DE SANGRE REGISTRADOS");
    }
}
